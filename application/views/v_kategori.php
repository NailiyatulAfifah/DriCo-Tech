...
<div class="modal fade" id="tambah">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="color:white;"><h2>Tambah Kategori Jenis</h2>
			...
			<form action="<?=base_url('index.php/kategori/tambah')?>" method="post">
				<table>
					<tr>
						<td>Tipe Kategori</td>
						<td><input type="text" name="id_kategori" required class="form-control"></td>
					</tr>
					<tr>
						<td>Jenis</td>
						<td><input type="text" name="jenis" required class="form-control"></td>
					</tr>
				</table>
				<br>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<form action="<?=base_url('index.php/kategori/kategori_update')?>" method="post">
				...
				<tr>
					<td>Tipe Kategori </td>
					<td><input type="text" name="id_kategori" id="id_kategori" required class="form-control">
					</td>
				</tr>
				<tr>
					<td>Jenis </td>
